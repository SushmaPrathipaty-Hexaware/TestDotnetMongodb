using TestDotnetMongodb.Api.Installer;
using TestDotnetMongodb.Api.Middleware;
using ElmahCore.Mvc;
...
using System;
using TestDotnetMongodb.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace TestDotnetMongodb.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "TestDotnetMongodb V1");
        });
