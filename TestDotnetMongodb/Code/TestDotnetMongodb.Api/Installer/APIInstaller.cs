...
using TestDotnetMongodb.Api.Filters;
using TestDotnetMongodb.BusinessServices.Installer;

namespace TestDotnetMongodb.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "TestDotnetMongodb API", Version = version + "-" + branch});
            });
